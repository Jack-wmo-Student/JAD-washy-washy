...
<link rel="stylesheet"
	href="<%=request.getContextPath()%>/assets/memberManagement.css">
</head>
<body>
	<%
    // Security checks
					...
					<div class="card">
                        ...
                        %>
								<tr>
									...
									<td><span
										class="badge <%= user.isIsAdmin() ? "bg-primary" : "bg-secondary" %>">
											<%= user.isIsAdmin() ? "Admin" : "User" %>
									</span></td>
									<td><span
										class="badge <%= user.isIsBlocked() ? "bg-danger" : "bg-success" %>">
